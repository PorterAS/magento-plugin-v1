...
/**
 * Class Convert_Porterbuddy_Block_Adminhtml_Frontend_Geoip_Synchronize
 *
 * Based on Sandfox_GeoIP
 */
class Convert_Porterbuddy_Block_Adminhtml_Frontend_Geoip_Synchronize extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /*
     * Set template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('convert/porterbuddy/geoip/synchronize.phtml');
    }
    ...
    {
        return Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/porterbuddy_geoip/synchronize');
    }
    ...
    {
        return Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/porterbuddy_geoip/status');
    }
